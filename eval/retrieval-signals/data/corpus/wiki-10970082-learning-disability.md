...
stable: true
context: >
  Learning disability, primary learning disorder, or learning difficulty (British English) is a condition in the brain that causes difficulties comprehending or processing information and can be caused by several different factors.
tags: [wikipedia, cognitive-science]
sources:
  - wikipedia:Learning_disability
links:
  - id: wiki-17995
  - id: wiki-1215674
...
Learning disability, primary learning disorder, or learning difficulty (British English) is a condition in the brain that causes difficulties comprehending or processing information and can be caused by several different factors.  Given the "difficulty learning in a typical manner", this does not exclude the ability to learn in a different manner. Therefore, some people can be more accurately described as having a "learning difference", thus avoiding any misconception of being disabled with a possible lack of an ability to learn and possible negative stereotyping. In the United Kingdom, the term learning disability generally refers to an intellectual disability, while conditions such as dyslexia and dyspraxia are usually referred to as learning difficulties.
