...
```bash
uv run --env-file .env python eval/integrate-level3/run.py             # all layers
uv run --env-file .env python eval/integrate-level3/run.py --classify  # Layer A only
uv run --env-file .env python eval/integrate-level3/run.py --edit      # Layer B EDIT only
uv run --env-file .env python eval/integrate-level3/run.py --split     # Layer B SPLIT only
```
