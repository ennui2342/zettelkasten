...
Usage:
    uv run --env-file .env python model-tests/baseline/run.py           # all tests
    uv run --env-file .env python model-tests/baseline/run.py --case 1
    uv run --env-file .env python model-tests/baseline/run.py --case 1,3,5
    uv run --env-file .env python model-tests/baseline/run.py --list
    uv run --env-file .env python model-tests/baseline/run.py --setup
"""
