...
Usage:
  uv run --env-file .env python model-tests/ingestion-harness/run.py --status
  uv run --env-file .env python model-tests/ingestion-harness/run.py --list
  uv run --env-file .env python model-tests/ingestion-harness/run.py --next
  uv run --env-file .env python model-tests/ingestion-harness/run.py --paper 3
  uv run --env-file .env python model-tests/ingestion-harness/run.py --rewind 3
  uv run --env-file .env python model-tests/ingestion-harness/run.py --context
  uv run --env-file .env python model-tests/ingestion-harness/run.py --context 5
"""
