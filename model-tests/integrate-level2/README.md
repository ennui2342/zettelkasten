...
```bash
uv run --env-file .env python model-tests/integrate-level2/run.py             # all cases
uv run --env-file .env python model-tests/integrate-level2/run.py --only update
uv run --env-file .env python model-tests/integrate-level2/run.py --only create
uv run --env-file .env python model-tests/integrate-level2/run.py --only nothing
```
...
9 cases drawn from `model-tests/integration-decisions/` ground truth. Data is self-contained in `data/` (13 notes).
